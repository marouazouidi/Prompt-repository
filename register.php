...
<body>
    ...
    <form action="" method="POST">
        <input type="text" name="username" placeholder="Nom" autocomplete="new-nom"><br>
        <input type="email" name="email" placeholder="Email" autocomplete="new-email"><br>
        <input type="password" name="password" placeholder="Mot de passe" autocomplete="new-password"><br>
